(function ($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    prevImage() {
      // Les fonctions activeImage et activeImageSrc n'étaient pas définies correctement
      ...
      // index n'était pas défini correctement, et ne pouvait pas aller chercher l'image sur laquelle on clique
      let index = imagesCollection.findIndex((img) => $(img).attr("src") === $(activeImage).attr("src"));

      // next nétait pas défini, donc ne pouvait pas faire défiler correctement la galerie quand on clique sur les flèches de la modale
    ...
    filterByTag() {
      ...
      // Le terme "active" était manquant devant "active-tag", les modifs ne s'affichaient donc pas
